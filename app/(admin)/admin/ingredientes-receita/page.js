    ...
    const fetchReceitasComIngredientes = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `/api/admin/receitas/com-ingredientes?page=${page}&perPage=${pagination.perPage}`
            );
    ...
    if (loading && totalReceitas === 0) {
        return (
            <div className="loading-container">
                ...
                <p>Carregando receitas com ingredientes...</p>
            </div>
        );
    }
    ...
    return (
        <div className="usuario-admin-container">
            ...
            <div className="usuario-lista-admin">
                <h1>Receitas com Ingredientes ({totalReceitas})</h1>
                ...
                {totalReceitas > 0 ? (
                        ...
                        <div className="receitas-grid">
                            {receitas.map(receita => (
                                <div key={receita.id_receita} className="receita-card">
                                    <Link href={`/admin/ingredientes-receita/receita/${receita.id_receita}`}>
                                        <div className="receita-image-container">
                                            ...
                                            <div className="feedback-count">
                                                <FaCarrot /> {receita._count?.titulosIngrediente || 0}
                                            </div>
                                        </div>
                    ...
                    <div className="empty-message">
                        Nenhuma receita com ingredientes encontrada.
                    </div>
                )}
