    ...
    const fetchReceitasComFeedback = async (page = 1) => {
        try {
            ...
            const response = await fetch(
                `/api/admin/receitas/com-feedback?page=${page}&perPage=${pagination.perPage}`
            );
            ...
            if (!result.success) {
                throw new Error(result.error || 'Erro ao carregar receitas com feedback');
            }
            ...
            console.error('Erro ao carregar receitas com feedback:', err);
    ...
    if (loading && totalReceitas === 0) {
        return (
            <div className="loading-container">
                ...
                <p>Carregando receitas com feedback...</p>
            </div>
        );
    }
    ...
    return (
        <div className="usuario-admin-container">
            ...
            <div className="usuario-lista-admin">
                <h1>Receitas com Feedback ({totalReceitas})</h1>
                ...
                {totalReceitas > 0 ? (
                        ...
                        <div className="receitas-grid">
                            {receitas.map(receita => (
                                <div key={receita.id_receita} className="receita-card">
                                    <Link href={`/admin/feedbacks/receitas/${receita.id_receita}`}>
                                        <div className="receita-image-container">
                                            ...
                                            <div className="feedback-count">
                                                <FiMessageSquare /> {receita._count.feedbacks}
                                            </div>
                                        </div>
                    ...
                    <div className="empty-message">
                        Nenhuma receita com feedback encontrada.
                    </div>
                )}
