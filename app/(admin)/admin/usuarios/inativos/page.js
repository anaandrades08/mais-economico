...
export default function UsuariosAdmin() {
  ...
  const usuariosPaginados = inativos.slice(indexInicial, indexFinal)
  const totalPaginas = Math.ceil(inativos.length / usuariosPorPagina)
          ...
          <div className="usuario-admin-box">
            {usuariosPaginados.length > 0 ? (
              usuariosPaginados.map(usuario => (
                <div id="inativos" key={usuario.id} className="usuario-admin-card usuario-inativo">
