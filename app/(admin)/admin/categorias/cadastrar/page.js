...
export default function CadastrarCategoriaAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataToSend.append('link_categoria', formData.link_categoria);
            ...
            if (!response.ok) {
                throw new Error(result.error || 'Erro ao cadastrar categoria');
            }
