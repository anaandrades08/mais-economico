...
import { FiAlertCircle, FiCheckCircle, FiLoader, FiTrash2, FiArrowLeft, FiEdit } from 'react-icons/fi';
import { useSession } from "next-auth/react";

export default function DetalhesIngredienteAdmin() {
    ...
    return (
        <div className="usuario-admin-container">
            <MenuLateral />
            <section className="usuario-cadastro-admin">
                <h1>Visualizar Ingrediente #{id_ingrediente}</h1>
                ...
                <div className="usuario-cadastro-botoes">
                    ...
                    <Link href={`/admin/ingredientes/alterar/${ingrediente.id_ingrediente}`} className="back-button">
                            <button
                                type="button"
                                disabled={loading}
                                className="secondary"
                            >
                                <FiEdit size={20} /> Alterar
                            </button>
                        </Link>
                     <Link href="/admin/ingredientes" className="back-button">
                            <button
