//api/receitas/receitas-novas/route.js
...
export async function GET() {
    try {
      const receitasAtivas = await prisma.receita.findMany({
        where: {
          ativo: null, // somente receitas novas
        },
        orderBy: {
      ...
      console.error('Erro ao buscar receitas novas:', error);
      return NextResponse.json(
        { error: 'Erro ao buscar receitas novas' },
        { status: 500 }
      );
    }
  }
