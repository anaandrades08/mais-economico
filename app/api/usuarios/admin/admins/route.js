// app/api/usuarios/admin/admins/route.js
    ...
    try {
        ...
        const [usuarios, total] = await prisma.$transaction([
            prisma.usuario.findMany({
                ...
                take: perPage,
                where: {
                    tipo: 1, // Filtrar apenas usuários admins
                },
        ...
        console.error('Erro ao buscar usuários admins:', error);
        return NextResponse.json(
            { 
                success: false,
                error: 'Erro ao buscar usuários admins',
